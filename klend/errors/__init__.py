...
from . import kaminoLending


def from_code(code: int) -> typing.Union[kaminoLending.CustomError, None]:
    return kaminoLending.from_code(code)
...
def from_tx_error(
    error: RPCException,
) -> typing.Union[kaminoLending.CustomError, None]:
