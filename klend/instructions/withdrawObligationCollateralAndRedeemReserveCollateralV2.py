...
class WithdrawObligationCollateralAndRedeemReserveCollateralV2Args(typing.TypedDict):
...
class WithdrawObligationCollateralAndRedeemReserveCollateralV2Accounts(typing.TypedDict):
    owner:SolPubkey
...
def WithdrawObligationCollateralAndRedeemReserveCollateralV2(
    ...
    identifier = b"\xeb\x34\x77\x98\x95\xc5\x14\x07"
