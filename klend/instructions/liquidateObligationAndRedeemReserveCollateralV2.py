...
class LiquidateObligationAndRedeemReserveCollateralV2Args(typing.TypedDict):
    liquidityAmount:int
...
class LiquidateObligationAndRedeemReserveCollateralV2Accounts(typing.TypedDict):
...
def LiquidateObligationAndRedeemReserveCollateralV2(
    ...
    identifier = b"\xa2\xa1\x23\x8f\x1e\xbb\xb9\x67"
