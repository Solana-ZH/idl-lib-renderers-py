...
class BorrowObligationLiquidityV2Args(typing.TypedDict):
    liquidityAmount:int
...
class BorrowObligationLiquidityV2Accounts(typing.TypedDict):
    owner:SolPubkey
...
def BorrowObligationLiquidityV2(
    ...
    identifier = b"\xa1\x80\x8f\xf5\xab\xc7\xc2\x06"
