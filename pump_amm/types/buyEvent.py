...
class BuyEvent:
    ...
    protocolFeeRecipient: SolPubkey
    protocolFeeRecipientTokenAccount: SolPubkey
    ...
    def from_decoded(cls, obj: Container) -> "BuyEvent":
        ...
        protocolFeeRecipientTokenAccount=obj["protocolFeeRecipientTokenAccount"],
        )
    ...
    def from_json(cls, obj: BuyEventJSON) -> "BuyEvent":
        return cls(
                ...
                protocolFeeRecipient=SolPubkey.from_string(obj["protocolFeeRecipient"]),
                protocolFeeRecipientTokenAccount=SolPubkey.from_string(obj["protocolFeeRecipientTokenAccount"]),
        )
