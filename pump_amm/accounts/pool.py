...
class Pool:
    ...
    def decode(cls, data: bytes) -> "Pool":
        ...
        dec = Pool.layout.parse(data[cls.DISCRIMINATOR_SIZE:])
        return cls(
    ...
    def from_json(cls, obj: PoolJSON) -> "Pool":
        return cls(
                ...
                poolBaseTokenAccount=SolPubkey.from_string(obj["poolBaseTokenAccount"]),
                poolQuoteTokenAccount=SolPubkey.from_string(obj["poolQuoteTokenAccount"]),
